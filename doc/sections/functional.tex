...
The so-called \lstinline{standard} is a popular shape which comprises spheres
and some quadrics of revolution around axis z.
...
The altitude is defined as follows. We use the same expression as in
commercial software.
...
\textcolor{red}{TODO: Give range of $r$ where the altitude is defined. Depends
on sign of $(k+1)$.}
