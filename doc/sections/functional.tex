...
The transfer operation operates a change of basis and an intersection with
the newly defined local plane.
...
\item transfer operation illustration (with a ray)
\end{itemize}}
