...
to provide a rationale for how it was defined from quadrics. Additionally,
we check the formula consistency with respect to \lstinline{sphere}.
...
\subsubsection{Link with general quadrics}
...
\textcolor{red}{TODO: operate the coordinate change to obtain the normal form.
See if there is a table in the wiki references.}.

\subsubsection{Rationale for defining the shape from quadrics}

\subsubsection{Formula consistency: sphere case}
