...
\textcolor{red}{TODO:
* Describe the sphere normal vector using both the geometry explanation CI,
  and the $z=f(x,y)$ formula.}
...
an intersection point. We arrive at the result from two (slightly) different
starting points.
